...
<div id="gbox">
          ...
          <div id="gbox-bg">
            <div id="gbox-grd">
              ...
              <h2 id="error"></h2>
              <br>       
  {!! Form::open(['route' => 'Adduser.store', 'class' => 'form-horizontal', 'role' => 'form']) !!}
      <table witdh="200px">
          <tr>
          @if(Sentinel::check())	
              <td id="label">Nama pemesan</td>
              <td colspan="2">&nbsp;: {!! Form::text('nama_pemesan',$nama, array('size'=>14,'placeholder'=>'masukan nama pemesan','readonly'=>'true')) !!}	
							</td>
