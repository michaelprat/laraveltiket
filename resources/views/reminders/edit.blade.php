...
{!! Form::open(['route' => ['reminders.update',$id,$code], 'class' => 'form-horizontal', 'role' => 'form']) !!}
      <table witdh="200px">
          <tr>
              <td id="label">Enter your new Password</td>
              <td colspan="2">&nbsp;: {!! Form::password('password', null, array('size'=>14,'placeholder'=>'input new password')) !!}	
							</td>
...
<tr>
              <td id="label">Re enter new Password</td>
              <td colspan="2">&nbsp;:{!! Form::password('password_confirmation', null, array('size'=>14,'placeholder'=>'re input new password')) !!}</td>
...
@if(count($errors)>0)
  ...
  {!! Form::submit('Reset Password') !!}&nbsp;&nbsp; {!! Form::reset('Reset') !!}
  {!! Form::close() !!}
</div>
</div>
</div>
